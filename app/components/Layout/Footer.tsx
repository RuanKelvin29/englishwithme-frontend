      ...
      <div className="footer-container">
        ...
        <div className="footer-col">
          ...
          <p className="footer-desc">
            Nền tảng luyện thi và học tiếng Anh trực tuyến hàng đầu. Cải thiện kỹ năng của bạn mỗi ngày với các bài test chất lượng cao.
          </p>
        </div>
        ...
        <div className="footer-col">
          ...
          <ul className="footer-links">
            ...
            <li><Link href="/test">Practice Tests</Link></li>
            {/*
            <li><Link href="/grammar">Grammar Tips</Link></li>
        ...
        <div className="footer-col">
          ...
          <p className="footer-contact">Email: ndtmuku@gmail.com</p>
          <p className="footer-contact">Phone: +84 869 154 840</p>
