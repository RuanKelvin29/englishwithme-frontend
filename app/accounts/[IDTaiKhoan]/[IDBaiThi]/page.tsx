...
export default function SubmissionDetailPage() {
  ...
  const { IDTaiKhoan, IDBaiThi } = useParams();
  ...
  if (loading) return <p className="submission-status-msg animate-pulse-text">Loading {IDTaiKhoan} submission...</p>;
  ...
  return (
    <div className="submission-detail-container">
      ...
      <button onClick={() => router.push(`/account/${IDTaiKhoan}`)} className="btn-back">
        <ArrowLeft size={20} />
        Return
      </button>
      ...
      <div className={`submission-score-card ${getScoreCardClass()}`}>
        <div className="submission-score-header">
          <h2 className="font-bold text-xl text-gray-700">Result</h2>
        ...
        <div className="submission-info-grid">
          ...
          <div className="submission-info-item">
            ...
            <span className="submission-info-label">Duration:</span>
          ...
          <div className="submission-info-item">
            ...
            <span className="submission-info-label">Start Time:</span>
            <span className="submission-info-value">
          ...
          <div className="submission-info-item">
            ...
            <span className="submission-info-label">Submit Time:</span>
            <span className="submission-info-value">
          ...
          <div className="space-y-8">
            {submission.Part2.map((dv: any) => (
              <div key={dv.IDDoanVan} className="passage-card">
                ...
                {dv.Audio && (
                  <audio controls className="question-audio-player mb-4">
                    <source src={dv.Audio} type="audio/mpeg" />
                  </audio>
                )}
